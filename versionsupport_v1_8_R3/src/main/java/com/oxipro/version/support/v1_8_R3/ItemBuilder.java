...
public class ItemBuilder implements com.oxipro.bedWars2023AdvancedGUI.api.Support.VersionSupport.ItemBuilder {
    ...
    public ItemBuilder(String input, v1_8_R3 v1_8_r3) {
...
//        this.item = v1_8_r3.setItemTag(item, "agui.type" , type);
    ...
    public ItemStack build() {
        ...
        if (name != null) {
            v1_8_r3.getPlatformSupport().applyDisplayName(item, name);
        }
        if (lore != null) {
            v1_8_r3.getPlatformSupport().applyLore(item, lore);
        }
        if (category != null) {
            item = v1_8_r3.setItemTag(item, "agui.category", category);
        }
        if (type != null) {
            item = v1_8_r3.setItemTag(item, "agui.type", type);
        }
        if (arena != null) {
            item = v1_8_r3.setItemTag(item, "agui.arena", arena);
        }
        return item;
    }
